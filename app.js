...
const I18N = {
    es: { admin_access: "Acceso de Administrador", email: "Email:", password: "Contraseña:", login: "Iniciar Sesión", query_title: "Consulta tus Boletas", query_desc: "Escribe tu número de WhatsApp y te mostramos qué números tienes reservados o pagados.", phone: "Teléfono (WhatsApp):", search_tickets: "Buscar mis Boletas", history_winners: "Ganadores Anteriores", loading: "Calentando motores, ya casi arrancamos", theme: "Colores", my_tickets: "Mis Boletas", history: "Ganadores", select_visual: "Elige el estilo que más te guste:", custom_color: "O ponle tu propio color:", how_to_win: "¿Cómo te ganas esta nave?", instruction_1: "Escoge tu número, del <b>0000 al 9999</b>. El de tu cumpleaños, el de la placa del carro, el que se te dé la gana.", instruction_2: "Haz tu reserva y mándanos el comprobante por WhatsApp.", instruction_3: "Y ya quedaste. Entras a los sorteos semanales y al sorteo de la moto.", colors: "¿Qué significan los colores?", free: "Libre", reserved: "Reservado", paid: "Pagado", main_prize: "Una Pulsar NS400Z 0KM, o si prefieres, $25.000.000 en efectivo", ticket: "Boleta", final_draw: "Sorteo Final:", lottery: "Con la Lotería de Santander, la de verdad, la oficial", weekly_prize: "Un millón de pesos cada semana", until: "hasta el 18 de diciembre", progress: "Cómo va la rifa", time_left: "¿Cuánto falta?", next_weekly: "Próximo sorteo semanal", completed_tickets: "Así va la cosa", total: "Total de boletas", tickets_24h: "boletas se movieron en las últimas 24 horas. No te vayas a quedar viendo un chispero.", select_numbers: "Escoge tus números (del 0000 al 9999)", show_all: "Ver todos", grid: "Cuadrícula", testimonials_title: "Gente que ya se ganó algo (no nos lo inventamos)", faq_title: "Preguntas que todo el mundo hace", faq_1_q: "¿Cuándo me gano la moto?", faq_1_a: "El día de la verdad es el <b>25 de diciembre de 2026</b>, con la Lotería de Santander. Si tu boleta está en rojo, o sea <b>PAGADA</b>, ya estás metido en la jugada.", faq_2_q: "¿Tengo que estar pegado al celular todo el día para ganar?", faq_2_a: "Para nada. Si te ganaste algo, te llamamos nosotros hasta debajo de las piedras. Tú solo procura no quedarte sin batería.", faq_3_q: "¿Cómo sé que mi compra sí quedó guardada?", faq_3_a: "Sin cuentos raros. Apenas mandas el comprobante, tu número pasa a rojo automáticamente y queda registrado. Todo a la vista de todos.", faq_4_q: "¿Puedo comprar varios números para asegurar?", faq_4_a: "Claro que sí. Con uno solo ya estás jugando, pero entre más números tengas, más chances te guardas y menos le dejas al vecino.", faq_5_q: "¿Qué significan los colores de los números?", faq_5_a: "<b>Libre:</b> todavía nadie lo ha tocado, es todo tuyo si te apuras.<br><b>Reservado:</b> alguien lo apartó pero aún no paga, así que puede volver a quedar libre.<br><b>Pagado:</b> ese número ya tiene dueño y está jugando en serio.", faq_6_q: "Si me gano la moto, ¿cómo me la entregan?", faq_6_a: "Con los papeles al día, las llaves en la mano y lista para que te la lleves a rodar el mismo día.", faq_7_q: "¿Esto es de fiar o me están viendo la cara?", faq_7_a: "El sistema guarda tus reservas y pagos automáticamente, sin errores raros ni letra pequeña. Y si quieres pruebas, ahí tienes los testimonios y la lista de ganadores anteriores.", contact_dev: "Contacto Directo", legal: "Legal", total_to_pay: "Total a Pagar", participate_now: "Quiero Participar", confirm_reservation: "Confirma tu Reserva", about_to_reserve: "Estás a punto de reservar estos números:", reserve_warning: "Llena tus datos para que podamos contactarte y confirmar tu pago. La reserva se mantiene por 2 horas, después vuelve a quedar libre para cualquiera.", payment_accounts: "Cuentas para pagar:", full_name: "Nombre Completo:", contact_phone: "Tu WhatsApp:", promo_code: "Código Promocional (si tienes uno):", reserve_and_wa: "RESERVAR Y AVISAR POR WHATSAPP", referral_msg: "Tu link para invitar amigos:" },
